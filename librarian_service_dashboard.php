    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div class="leftinnerdiv">
                <Button class="greenbtn"> LIBRARIAN'S DESK</Button>            
                ...
                <Button class="greenbtn" onclick="openpart('studentrecord')"> <img class="icons" src="images/icon/monitoring.png" width="30px" height="30px"/> MEMBER DETAILS</Button>
        ...
        <!-- BOOK REQUEST APPROVE -->
            <div class="rightinnerdiv">   
                ...
                <?php
                    ...
                    $table="<table style='font-family: math;border-collapse: collapse;width: 100%;'><tr><th style='
        ...
        <!-- ADD NEW BOOK -->
            <div class="rightinnerdiv">   
                ...
                <br>
                <form action="addbookserver_page.php" method="post" enctype="multipart/form-data" style="margin-top: 10px ;background-color: whitesmoke">
                <label>Book Name:</label><input type="text" name="bookname"/></br>
                <label>Details:</label><input  type="text" name="bookdetail"/></br>
                <label>Author:</label><input type="text" name="bookauthor"/></br>
                <label>Publication:</label><input type="text" name="bookpub"/></br>
                <div><label>Branch:</label>
                    <input type="radio" name="branch" value="B.Sc"/>B.Sc
                    <input type="radio" name="branch" value="B.Tech"/>B.tech
                    <input type="radio" name="branch" value="BA"/>BA<div style="margin-left:80px">
                    <input type="radio" name="branch" value="MA"/>MA
                    <input type="radio" name="branch" value="M.Sc"/>M.Sc
                    <input type="radio" name="branch" value="MBBS"/>MBBS
        ...
        <!-- add Member -->
            <div class="rightinnerdiv">  
                ...
                <Button class="greenbtn" >ADD NEW MEMBER</Button>
                ...
                <select name="type" >
                    ...
                    <option value="BCA Student">BCA Student</option>
                    <option value="M.Sc Student">M.Sc Student</option>
                    <option value="BA Student">BA Student</option>
                    <option value="MA Student">MA Student</option>
        ...
        <!-- Member record -->
            <div class="rightinnerdiv">   
                ...
                <Button class="greenbtn" >Member's Record</Button>
        ...
        <!-- BOOK DETAIL -->
            <div class="rightinnerdiv">   
                ...
                ?>
                <img width='150px' height='150px' style='border:1px solid #333333; float:left;margin-left:20px;margin-top: 7px' src="uploads/<?php echo $bookimg?> "/>
                </br>
            ...
            <div class="rightinnerdiv">   
                ...
                <?php
                    ...
                    "<td>$row[0]</td>";
                        ...
                        $table.="<td>$row[9]</td>";
                        $table.="<td>$row[10]</td>";
                        $table.="<td><a href='librarian_service_dashboard.php?viewid=$row[0]'><button type='button' class='btn btn-primary'>View Book</button></a></td>";
                        // $table.="<td><a href='deletebook_dashboard.php?deletebookid=$row[0]'>Delete</a></td>";
                        $table.="</tr>";
                        // $table.=$row[0];
                    }
