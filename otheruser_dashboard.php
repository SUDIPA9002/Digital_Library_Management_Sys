...
<html>
    ...
    <style>
        body {
            font-family: 'Roboto';
            background-image: url('images/lib_member.jpg');
    ...
    ?>
        <div class="container">
                ...
                <div class="leftinnerdiv">
                    ...
                    <Button class="greenbtn" onclick="openpart('issuereport')"> <img class="icons" src="images/icon/monitoring.png" width="30px" height="30px"/>  Return Book</Button>
                ...
                <div class="rightinnerdiv">   
                    ...
                    <p style="color:black"><u>Member Name:</u> &nbsp&nbsp<?php echo $name ?></p>
                    <p style="color:black"><u>Member Email:</u> &nbsp&nbsp<?php echo $email ?></p>
